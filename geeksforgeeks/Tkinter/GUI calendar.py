...
def showCal():
    ...
    new_gui.config(background='white') # set the background colour of GUI window
...
if __name__ == '__main__':
    ...
    gui.config(background='white') # set the background colour of GUI window
    ...
    year = Label(gui, text='Enter year', bg='light green') # create a enter year: label
