...
def check1(str1):
	if all((letter in '01') for letter in str1):
		return 'Yes'
	return 'No'


if __name__ == '__main__':
	str1 = '101011000111'; str2 = '201000001'
...
def is_binary_string4(str1):

	unique_items = {item for item in str1}
