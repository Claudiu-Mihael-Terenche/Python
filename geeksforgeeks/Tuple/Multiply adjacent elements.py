...
'''
# Python3 code to do adjacent element multiplication using zip() + generator expression + tuple
...
# adjacent element multiplication using zip() + generator expression + tuple
